...
import 'package:herba_scan/app/modules/auth/bindings/auth_binding.dart';
import 'package:herba_scan/app/modules/auth/views/auth_view.dart';
import 'package:herba_scan/app/modules/auth/views/forget_password_view.dart';
import 'package:herba_scan/app/modules/home/bindings/home_binding.dart';
import 'package:herba_scan/app/modules/home/views/home_view.dart';
import 'package:herba_scan/app/modules/leaf-scan/bindings/leaf_scan_binding.dart';
import 'package:herba_scan/app/modules/leaf-scan/views/leaf_scan_view.dart';
import 'package:herba_scan/app/modules/plant/bindings/plant_binding.dart';
...
import 'package:herba_scan/app/modules/setting/views/setting_view.dart';
part 'app_routes.dart';

class AppPages {
  AppPages._();
  static const INITIAL = Routes.LEAF_SCAN;
  static final routes = [
    GetPage(
      name: _Paths.HOME,
      page: () => const HomeView(),
